...
public class CurrentlyReadingActivity extends AppCompatActivity implements BooksRecViewAdapter.ChangeStatus {

    private static final String TAG = "CurrentlyReading";
    ...
    public void onChangeStatusResult(Book book, String status) {
        ...
        try{
            ...
            if(rowAffected > 0){
                Toast.makeText(this, book.getName() + " has been removed from currently readings", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        super.onStart();
        adapter = new BooksRecViewAdapter(this,"CurrentlyReadingActivity");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Currently Reading Books");
    ...
    private class DatabaseAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            databaseHelper = new DatabaseHelper(CurrentlyReadingActivity.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                cursor = database.query("books", null, "status=?", new String[] {"current"},
                        null, null,null);
