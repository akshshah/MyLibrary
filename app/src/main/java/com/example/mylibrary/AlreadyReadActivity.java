...
public class AlreadyReadActivity extends AppCompatActivity implements BooksRecViewAdapter.ChangeStatus {
    ...
    public void onChangeStatusResult(Book book, String status) {
        ...
        try{
            ...
            if(rowAffected > 0){
                Toast.makeText(this, book.getName() + " has been removed from already read list", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        adapter = new BooksRecViewAdapter(this,"AlreadyReadActivity");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Already Read Books");
    ...
    private class DatabaseAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            databaseHelper = new DatabaseHelper(AlreadyReadActivity.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                cursor = database.query("books", null, "status=?", new String[] {"alreadyRead"},
                        null, null,null);
